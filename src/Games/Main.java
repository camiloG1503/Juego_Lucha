...
import Games.factory.ElfoFactory;
import Games.factory.BestiaFactory;
...
public class Main {
    public static void main(String[] args) {
        ...
        PersonajeFactory factory1 = new BestiaFactory();
        PersonajeFactory factory2 = new ElfoFactory();
